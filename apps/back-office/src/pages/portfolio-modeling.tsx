...
export default function PortfolioModeling() {
  ...
  const actionsQ = useQuery<{ data: RebalanceAction[] }>({
  ...
  const runsQ = useQuery<{ data: RebalancingRun[] }>({
