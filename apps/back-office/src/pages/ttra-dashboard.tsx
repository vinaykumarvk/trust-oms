...
const statusColors: Record<string, string> = {
  APPLIED: 'bg-blue-100 dark:bg-blue-900 text-blue-800',
  UNDER_REVIEW: 'bg-yellow-100 dark:bg-yellow-900 text-yellow-800',
  APPROVED: 'bg-green-100 dark:bg-green-900 text-green-800',
  REJECTED: 'bg-red-100 dark:bg-red-900 text-red-800',
  EXPIRED: 'bg-gray-100 text-gray-800',
  RENEWAL_PENDING: 'bg-orange-100 dark:bg-orange-900 text-orange-800',
};
        ...
        {data.map((app: any) => {
          ...
          return (
            <TableRow key={app.ttra_id}>
              ...
              <TableCell>{app.effective_to}</TableCell>
              <TableCell>
                <Badge className={daysLeft <= 15 ? 'bg-red-100 dark:bg-red-900 text-red-800' : daysLeft <= 30 ? 'bg-orange-100 dark:bg-orange-900 text-orange-800' : 'bg-yellow-100 dark:bg-yellow-900 text-yellow-800'}>
                  {daysLeft}d
                </Badge>
              </TableCell>
              <TableCell>{app.next_review_due}</TableCell>
