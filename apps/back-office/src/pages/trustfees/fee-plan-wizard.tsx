            ...
            <div className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                {form.pricing_binding_mode === "LATEST_APPROVED" && (
                  <div className="flex items-center gap-2 rounded-md bg-amber-50 dark:bg-amber-950 px-3 py-2 text-sm text-amber-700 dark:text-amber-300">
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          {previewResult.eligibility_result !== null && (
                            <div>
                              ...
                              <Badge className={previewResult.eligibility_result ? "bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200" : "bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-200"}>
