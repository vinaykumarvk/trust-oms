...
export const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Danamon OEMS", path: "/operations/oems", icon: ClipboardList },
      { label: "FX ODA Product Setup", path: "/operations/oems-product-setup-oda", icon: ClipboardList },
      { label: "MLD Product Setup", path: "/operations/oems-product-setup-mld", icon: ClipboardList },
      { label: "ODA Ticket", path: "/operations/oems-ticket-oda", icon: ShieldCheck },
      { label: "Product Tickets", path: "/operations/oems-product-tickets", icon: ClipboardCheck },
      { label: "Control Tower", path: "/operations/oems-control-tower", icon: Gauge },
      { label: "Rule Traceability", path: "/operations/oems-rule-traceability", icon: GitBranch },
