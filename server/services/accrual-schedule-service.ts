  ...
  async create(data: {
    ...
    const [schedule] = await db
      ...
      .values({
        ...
        accrual_method: data.accrual_method ?? 'ABSOLUTE',
        basis_frequency: data.basis_frequency ?? null,
        accounting_enabled: data.accounting_enabled ?? false,
        accounting_frequency: data.accounting_frequency ?? null,
        ...
        recovery_frequency: data.recovery_frequency ?? null,
  ...
  async update(id: number, data: Record<string, unknown>) {
    ...
    const [updated] = await db
      ...
      .set({
        ...
        ...(data.accrual_frequency !== undefined && { accrual_frequency: data.accrual_frequency }),
        ...(data.accrual_method !== undefined && { accrual_method: data.accrual_method }),
        ...(data.basis_frequency !== undefined && { basis_frequency: data.basis_frequency }),
        ...(data.accounting_enabled !== undefined && { accounting_enabled: data.accounting_enabled as boolean }),
        ...(data.accounting_frequency !== undefined && { accounting_frequency: data.accounting_frequency }),
        ...(data.invoice_frequency !== undefined && { invoice_frequency: data.invoice_frequency }),
        ...
        ...(data.recovery_frequency !== undefined && { recovery_frequency: data.recovery_frequency }),
