...
async function seedOdaProducts() {
  ...
  if (existing >= 14) { console.log(`  oems_products: ${existing} (sufficient)`); return; }
  ...
  const products = [
    ...
    {
      product_code: 'MF-202605-001',
      product_name: 'PH Equity Growth UITF',
      product_family: 'MUTUAL_FUND' as const,
      currency: 'PHP',
      product_score: 4,
      product_status: 'ACTIVE' as const,
      is_active: true,
      min_subscription_amount: '10000',
      parameter_json: { pricing: { front_end_load_pct: 2.0, back_end_load_pct: 0.5, switching_fee_pct: 0.25 } },
      submitted_by: 'SYSTEM',
      submitted_at: daysAgo(90),
      approved_by: 'BO_CHECKER_1',
      approved_at: daysAgo(89),
    },
    {
      product_code: 'MF-202605-002',
      product_name: 'PH Balanced Fund',
      product_family: 'MUTUAL_FUND' as const,
      currency: 'PHP',
      product_score: 3,
      product_status: 'ACTIVE' as const,
      ...
      parameter_json: { pricing: { front_end_load_pct: 1.5, back_end_load_pct: 0.5, switching_fee_pct: 0.25 } },
      submitted_by: 'SYSTEM',
      submitted_at: daysAgo(90),
      approved_by: 'BO_CHECKER_1',
      approved_at: daysAgo(89),
    ...
    {
      product_code: 'MF-202605-003',
      product_name: 'PH Money Market Fund',
      product_family: 'MUTUAL_FUND' as const,
      currency: 'PHP',
      product_score: 1,
      product_status: 'ACTIVE' as const,
      ...
      parameter_json: { pricing: { front_end_load_pct: 0.5, back_end_load_pct: 0, switching_fee_pct: 0.1 } },
      submitted_by: 'SYSTEM',
      submitted_at: daysAgo(90),
      approved_by: 'BO_CHECKER_1',
      approved_at: daysAgo(89),
    ...
    {
      product_code: 'MF-202605-004',
      product_name: 'PH USD Dollar Bond Fund',
      product_family: 'MUTUAL_FUND' as const,
      currency: 'USD',
      product_score: 2,
      product_status: 'ACTIVE' as const,
      ...
      parameter_json: { pricing: { front_end_load_pct: 1.0, back_end_load_pct: 0.5, switching_fee_pct: 0.25 } },
      submitted_by: 'SYSTEM',
      submitted_at: daysAgo(60),
      approved_by: 'BO_CHECKER_1',
      approved_at: daysAgo(59),
    ...
    // ── Bond products ──
    {
      product_code: 'BOND-202605-001',
      product_name: 'Gov Bond PHP (T-Bond)',
      product_family: 'BOND' as const,
      currency: 'PHP',
      product_score: 1,
      product_status: 'ACTIVE' as const,
      is_active: true,
      min_subscription_amount: '100000',
      parameter_json: { pricing: { brokerage_commission_pct: 0.25 } },
      submitted_by: 'SYSTEM',
      submitted_at: daysAgo(120),
      approved_by: 'BO_CHECKER_1',
      approved_at: daysAgo(119),
    },
    {
      product_code: 'BOND-202605-002',
      product_name: 'Corporate Bond PHP',
      product_family: 'BOND' as const,
      currency: 'PHP',
      product_score: 2,
      product_status: 'ACTIVE' as const,
      ...
      parameter_json: { pricing: { brokerage_commission_pct: 0.30 } },
      submitted_by: 'SYSTEM',
      submitted_at: daysAgo(90),
      approved_by: 'BO_CHECKER_1',
      approved_at: daysAgo(89),
    ...
    // ── FX Today products ──
    {
      product_code: 'FXT-202605-001',
      product_name: 'FX Spot USD/PHP',
      product_family: 'FX_TODAY' as const,
      currency: 'PHP',
      product_score: 3,
      product_status: 'ACTIVE' as const,
      is_active: true,
      currency_pair_from: 'USD',
      currency_pair_to: 'PHP',
      reference_rate_source: 'BSP_REF',
      submitted_by: 'SYSTEM',
      submitted_at: daysAgo(60),
      approved_by: 'BO_CHECKER_1',
      approved_at: daysAgo(59),
    ...
    {
      product_code: 'FXT-202605-002',
      product_name: 'FX Spot EUR/PHP',
      product_family: 'FX_TODAY' as const,
      currency: 'PHP',
      product_score: 3,
      product_status: 'ACTIVE' as const,
    ...
    // ── Wealth Lending products ──
    {
      product_code: 'WL-202605-001',
      product_name: 'Wealth Secured Lending PHP',
      product_family: 'WEALTH_LENDING' as const,
      currency: 'PHP',
      product_score: 3,
      product_status: 'ACTIVE' as const,
      is_active: true,
      min_subscription_amount: '500000',
      parameter_json: { pricing: { facility_fee_pct: 0.5, processing_fee: 5000 } },
      submitted_by: 'SYSTEM',
      submitted_at: daysAgo(90),
      approved_by: 'BO_CHECKER_1',
      approved_at: daysAgo(89),
